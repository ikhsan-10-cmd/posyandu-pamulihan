<?php 
require_once __DIR__ . '/../pos_1/header_p1.php';
?>

<div class="container">
    <div class="jumbotron text-center">
        <h1 class="display-4 text-white">Dashboard Posyandu Cempaka 1</h1>
        <p class="lead text-white">Silakan pilih data yang ingin Anda kelola</p>
    </div>
    <div class="welcome-section">
        <p class="welcome-text">Selamat datang di sistem informasi Posyandu Cempaka 1 Desa Pamulihan. Pilih salah satu opsi di bawah untuk mengelola data.</p>
    </div>
        ...
        <div class="col-lg-4 col-md-6 mb-4">
            <div class="card section-card animate__animated animate__fadeInLeft animate__slow">
                <div class="card-body text-center">
                    ...
                    <a href="../posyandu_1/balita_p1.php" class="btn btn-primary btn-lg mt-3">
        ...
        <div class="col-lg-4 col-md-6 mb-4">
            <div class="card section-card animate__animated animate__fadeInRight animate__slow">
                <div class="card-body text-center">
                    ...
                    <a href="../posyandu_1/ibuhamil_p1.php" class="btn btn-primary btn-lg mt-3">
                        <i class="fas fa-arrow-right me-2"></i>Masuk
                    </a>
                </div>
            </div>
...
<?php include __DIR__ . '/../pos_1/footer_p1.php'; ?>