<?php 
require_once __DIR__ . '/../pos_4/header_p4.php';
?>

<div class="container">
    <div class="jumbotron text-center">
        <h1 class="display-4 text-white">Dashboard Posyandu Cempaka 4</h1>
        <p class="lead text-white">Silakan pilih data yang ingin Anda kelola</p>
    </div>
    <div class="welcome-section">
        <p class="welcome-text">Selamat datang di sistem informasi Posyandu Cempaka 4 Desa Pamulihan. Pilih salah satu opsi di bawah untuk mengelola data.</p>
    </div>
...
<?php include __DIR__ . '/../pos_4/footer_p4.php'; ?>