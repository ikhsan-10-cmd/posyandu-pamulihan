...
$months = ['january', 'febuary', 'maret', 'april', 'mei', 'juni', 'july', 'agustus', 'september', 'oktober', 'november', 'desember'];
?>
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha1/dist/js/bootstrap.bundle.min.js"></script>
    ...
    <div class="row">
        <div class="col-md-4">
            ...
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Pilih Balita dan Bulan</h5>
                    <form method="post">
                        <div class="form-group mb-3">
                            <label for="id_balita">Pilih Balita:</label>
        ...
        <div class="col-md-8">
            <?php if (!empty($balitaData)): ?>
                <?php $row = $balitaData[0]; // Get the first row of balita data ?>
                <div class="card mb-4">
                ...
                <?php if (!empty($pengukuranData)): ?>
                    <?php $pengukuran = $pengukuranData[0]; // Get the first row of pengukuran data ?>
                    <div class="card">
